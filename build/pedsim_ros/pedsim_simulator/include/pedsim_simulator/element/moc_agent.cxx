...
static const char qt_meta_stringdata_Agent[] = {
    "Agent\0positionChanged(double,double)\0"
    "x,y\0\0velocityChanged(double,double)\0"
    ...
    "myForceChanged(double,double)\0"
    "additionalForceChanged(QString,double,double)\0"
    "name,x,y\0reachedWaypoint()\0typeChanged(int)\0"
    "type\0forceAdded(QString)\0name\0"
    "forceRemoved(QString)\0"
};
