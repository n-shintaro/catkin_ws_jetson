...
static const char qt_meta_stringdata_WaitingQueue[] = {
    "WaitingQueue\0directionChanged(double)\0"
    "radianAngle\0\0agentMayPass(int)\0id\0"
    "agentDequeued(int)\0queueLeaderChanged(int)\0"
    "queueEndChanged()\0"
    "queueEndPositionChanged(double,double)\0"
    "x,y\0onTimeChanged(double)\0timeIn\0"
