...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /home/nvidia/catkin_ws/src/kobuki/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /home/nvidia/catkin_ws/devel)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/nvidia/catkin_ws/install)
...
if(NOT "/home/nvidia/catkin_ws/src/kobuki/kobuki_controller_tutorial/include " STREQUAL " ")
  set(kobuki_controller_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws/src/kobuki/kobuki_controller_tutorial/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/kobuki/kobuki_controller_tutorial/${idir}'.  ${_report}")
    endif()
